...
describe('delay spinning', () => {
  it("should render with delay when it's mounted with spinning=true and delay", () => {
    ...
    expect(wrapper.find('.dcloud-spin').at(0).hasClass('ant-spin-spinning')).toEqual(false);
  });
  ...
  it('should render when delay is init set', async () => {
    ...
    expect(wrapper.find('.dcloud-spin').at(0).hasClass('ant-spin-spinning')).toEqual(true);
  });
