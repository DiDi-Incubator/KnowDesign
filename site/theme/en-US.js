...
module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.components.extend': 'Extend Components',
    'app.header.menu.components.utils': 'Utils',
    'app.header.menu.components.hook': 'Custom Hook',
    'app.header.menu.components.commonpages': 'Common Pages',
