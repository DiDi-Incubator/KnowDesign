...
module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.components': '基础组件',
    'app.header.menu.components.extend': '业务组件',
    'app.header.menu.components.commonpages': '公共页面',
    'app.header.menu.components.utils': '工具库',
    'app.header.menu.components.hook': '自定义 Hook',
    ...
    'app.home.slogan': '一套基于Antd@4.x开发的组件扩展包',
